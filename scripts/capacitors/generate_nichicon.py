...
def generate_nichicon_capacitors(dest_dir, data_sources):
    dest_dir = dest_dir.joinpath('nichicon')
    ...
    ka_converter.generate(dest_dir.joinpath('nichicon_KA_generated.json'))
    ...
    vz_generator.generate(dest_dir.joinpath('nichicon_VZ_generated.json'))
